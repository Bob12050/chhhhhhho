...
export const ASSET_SPECS: AssetSpec[] = [
  ...
  sheet('鉄レイヤー:素体', 'assets/paperdoll-pilot/base-cardinal-v2.png'),
  diagonalSheet('鉄レイヤー:素体斜め', 'assets/paperdoll-pilot/base-diagonal-v2.png'),
  sheet('鉄レイヤー:頭', 'assets/paperdoll-pilot/helm-iron-cardinal-v2.png'),
  diagonalSheet('鉄レイヤー:頭斜め', 'assets/paperdoll-pilot/helm-iron-diagonal-v2.png'),
  sheet('鉄レイヤー:胴', 'assets/paperdoll-pilot/torso-iron-cardinal-v2.png'),
  diagonalSheet('鉄レイヤー:胴斜め', 'assets/paperdoll-pilot/torso-iron-diagonal-v2.png'),
  sheet('鉄レイヤー:手', 'assets/paperdoll-pilot/hands-iron-cardinal-v2.png'),
  diagonalSheet('鉄レイヤー:手斜め', 'assets/paperdoll-pilot/hands-iron-diagonal-v2.png'),
  sheet('鉄レイヤー:脚', 'assets/paperdoll-pilot/feet-iron-cardinal-v2.png'),
  diagonalSheet('鉄レイヤー:脚斜め', 'assets/paperdoll-pilot/feet-iron-diagonal-v2.png'),
  sheet('鉄レイヤー:剣', 'assets/paperdoll-pilot/sword-iron-cardinal-v2.png'),
  diagonalSheet('鉄レイヤー:剣斜め', 'assets/paperdoll-pilot/sword-iron-diagonal-v2.png'),
  sheet('鉄レイヤー:盾', 'assets/paperdoll-pilot/shield-iron-cardinal-v2.png'),
  diagonalSheet('鉄レイヤー:盾斜め', 'assets/paperdoll-pilot/shield-iron-diagonal-v2.png'),
