...
export const ASSET_SPECS: AssetSpec[] = [
  ...
  sheet('職業:魔法使い', 'assets/char/job_mage-storybook-v3.png'),
  diagonalSheet('職業:魔法使い斜め', 'assets/char/job_mage-diagonal-v1.png'),
  sheet('職業:僧侶', 'assets/char/job_priest-storybook-v3.png'),
  diagonalSheet('職業:僧侶斜め', 'assets/char/job_priest-diagonal-v1.png'),
  sheet('職業:盗賊', 'assets/char/job_thief-storybook-v3.png'),
  diagonalSheet('職業:盗賊斜め', 'assets/char/job_thief-diagonal-v1.png'),
  sheet('職業:ペット使い', 'assets/char/job_pet_raiser-storybook-v3.png'),
  diagonalSheet('職業:ペット使い斜め', 'assets/char/job_pet_raiser-diagonal-v1.png'),
  ...
  { label: '街背景', src: 'assets/maps/town-storybook-wide-v2.png', type: 'image', w: 640, h: 960 },
  { label: '草原背景', src: 'assets/maps/field-storybook-wide-v2.png', type: 'image', w: 640, h: 960 },
