...
export const ASSET_SPECS: AssetSpec[] = [
  ...
  hdSheet('男性プレイヤー本体HD', 'assets/char/player_body-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性プレイヤー本体:斜めHD', 'assets/char/player_body-male-diagonal-hd-v1.webp'),
  ...
  hdSheet('男性職業:ファイターHD', 'assets/char/job_fighter-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:ファイター斜めHD', 'assets/char/job_fighter-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:メイジHD', 'assets/char/job_mage-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:メイジ斜めHD', 'assets/char/job_mage-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:プリーストHD', 'assets/char/job_priest-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:プリースト斜めHD', 'assets/char/job_priest-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:シーフHD', 'assets/char/job_thief-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:シーフ斜めHD', 'assets/char/job_thief-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:ペットライザーHD', 'assets/char/job_pet_raiser-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:ペットライザー斜めHD', 'assets/char/job_pet_raiser-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:サムライHD', 'assets/char/job_samurai-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:サムライ斜めHD', 'assets/char/job_samurai-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:ソーサラーHD', 'assets/char/job_sorcerer-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:ソーサラー斜めHD', 'assets/char/job_sorcerer-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:ホーリーナイトHD', 'assets/char/job_holy_knight-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:ホーリーナイト斜めHD', 'assets/char/job_holy_knight-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:ニンジャHD', 'assets/char/job_ninja-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:ニンジャ斜めHD', 'assets/char/job_ninja-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:レンジャーHD', 'assets/char/job_ranger-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:レンジャー斜めHD', 'assets/char/job_ranger-male-diagonal-hd-v1.webp'),
  ...
  hdDiagonalSheet('男性職業:アベンジスタ斜めHD', 'assets/char/job_avengista-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:デュアルスターHD', 'assets/char/job_dual_star-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:デュアルスター斜めHD', 'assets/char/job_dual_star-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:アラミカグラHD', 'assets/char/job_aramikagura-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:アラミカグラ斜めHD', 'assets/char/job_aramikagura-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:アルヴライドHD', 'assets/char/job_alvride-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:アルヴライド斜めHD', 'assets/char/job_alvride-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:ニルバディオHD', 'assets/char/job_nirvadio-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:ニルバディオ斜めHD', 'assets/char/job_nirvadio-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:ノクスティアHD', 'assets/char/job_noxtia-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:ノクスティア斜めHD', 'assets/char/job_noxtia-male-diagonal-hd-v1.webp'),
  hdSheet('男性職業:オルタリエHD', 'assets/char/job_oltarie-male-storybook-hd-v1.webp'),
  hdDiagonalSheet('男性職業:オルタリエ斜めHD', 'assets/char/job_oltarie-male-diagonal-hd-v1.webp'),
