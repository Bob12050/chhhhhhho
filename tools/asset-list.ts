...
export const ASSET_SPECS: AssetSpec[] = [
  ...
  hdSheet('男性プレイヤー本体HD', 'assets/char/player_body-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性プレイヤー本体:斜めHD', 'assets/char/player_body-male-diagonal-hd-v2.webp'),
  ...
  hdSheet('男性職業:ファイターHD', 'assets/char/job_fighter-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ファイター斜めHD', 'assets/char/job_fighter-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:メイジHD', 'assets/char/job_mage-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:メイジ斜めHD', 'assets/char/job_mage-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:プリーストHD', 'assets/char/job_priest-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:プリースト斜めHD', 'assets/char/job_priest-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:シーフHD', 'assets/char/job_thief-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:シーフ斜めHD', 'assets/char/job_thief-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:ペットライザーHD', 'assets/char/job_pet_raiser-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ペットライザー斜めHD', 'assets/char/job_pet_raiser-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:サムライHD', 'assets/char/job_samurai-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:サムライ斜めHD', 'assets/char/job_samurai-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:ソーサラーHD', 'assets/char/job_sorcerer-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ソーサラー斜めHD', 'assets/char/job_sorcerer-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:ホーリーナイトHD', 'assets/char/job_holy_knight-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ホーリーナイト斜めHD', 'assets/char/job_holy_knight-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:ニンジャHD', 'assets/char/job_ninja-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ニンジャ斜めHD', 'assets/char/job_ninja-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:レンジャーHD', 'assets/char/job_ranger-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:レンジャー斜めHD', 'assets/char/job_ranger-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:ソードカイザーHD', 'assets/char/job_sword_kaiser-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ソードカイザー斜めHD', 'assets/char/job_sword_kaiser-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:グランマギアーHD', 'assets/char/job_grand_magia-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:グランマギアー斜めHD', 'assets/char/job_grand_magia-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:シルドセイバーHD', 'assets/char/job_shield_saber-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:シルドセイバー斜めHD', 'assets/char/job_shield_saber-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:アベンジスタHD', 'assets/char/job_avengista-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:アベンジスタ斜めHD', 'assets/char/job_avengista-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:デュアルスターHD', 'assets/char/job_dual_star-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:デュアルスター斜めHD', 'assets/char/job_dual_star-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:アラミカグラHD', 'assets/char/job_aramikagura-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:アラミカグラ斜めHD', 'assets/char/job_aramikagura-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:アルヴライドHD', 'assets/char/job_alvride-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:アルヴライド斜めHD', 'assets/char/job_alvride-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:ニルバディオHD', 'assets/char/job_nirvadio-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ニルバディオ斜めHD', 'assets/char/job_nirvadio-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:ノクスティアHD', 'assets/char/job_noxtia-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:ノクスティア斜めHD', 'assets/char/job_noxtia-male-diagonal-hd-v2.webp'),
  hdSheet('男性職業:オルタリエHD', 'assets/char/job_oltarie-male-storybook-hd-v2.webp'),
  hdDiagonalSheet('男性職業:オルタリエ斜めHD', 'assets/char/job_oltarie-male-diagonal-hd-v2.webp'),
  ...
  { label: '街背景HD', src: 'assets/maps/town-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: 'NPC会話マーカー', src: 'assets/ui/npc-interact-marker-v1.png', type: 'image', w: 256, h: 256 },
  { label: '草原背景ピクセルHD', src: 'assets/maps/field-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: '森背景ピクセルHD', src: 'assets/maps/forest-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: '洞窟背景ピクセルHD', src: 'assets/maps/dungeon-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: '渓谷背景ピクセルHD', src: 'assets/maps/canyon-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: '火山背景ピクセルHD', src: 'assets/maps/volcano-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: '雪原背景ピクセルHD', src: 'assets/maps/snowfield-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: '砂漠背景ピクセルHD', src: 'assets/maps/desert-pixel-plaza-hd-v1.webp', type: 'image', w: 1280, h: 1920 },
  { label: '草原の決闘場背景ピクセルHD', src: 'assets/maps/arena-plain-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '木立の闘技場背景ピクセルHD', src: 'assets/maps/arena-grove-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '火口の闘技場背景ピクセルHD', src: 'assets/maps/arena-volcano-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '氷霜の聖域背景ピクセルHD', src: 'assets/maps/arena-frost-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '洞窟の闘技場背景ピクセルHD', src: 'assets/maps/arena-cavern-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '沼地の闘技場背景ピクセルHD', src: 'assets/maps/arena-swamp-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '遺跡の闘技場背景ピクセルHD', src: 'assets/maps/arena-ruins-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '深淵の闘技場背景ピクセルHD', src: 'assets/maps/arena-abyss-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '湿地の闘技場背景ピクセルHD', src: 'assets/maps/arena-marsh-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '山頂の闘技場背景ピクセルHD', src: 'assets/maps/arena-peak-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '夜の闘技場背景ピクセルHD', src: 'assets/maps/arena-night-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  { label: '峡谷の闘技場背景ピクセルHD', src: 'assets/maps/arena-canyon-pixel-plaza-hd-v1.webp', type: 'image', w: 1080, h: 2400 },
  ...
  { label: 'NPC:道具屋ピクセル', src: 'assets/env/npc_merchant-pixel-plaza-v1.png', type: 'image', w: 192, h: 192, anchor: [96, 168] },
  { label: 'NPC:鍛冶屋ピクセル', src: 'assets/env/npc_craft-pixel-plaza-v1.png', type: 'image', w: 192, h: 192, anchor: [96, 168] },
  { label: 'NPC:ギルドピクセル', src: 'assets/env/npc_guild-pixel-plaza-v1.png', type: 'image', w: 192, h: 192, anchor: [96, 168] },
  { label: 'NPC:村長ピクセル', src: 'assets/env/npc_elder-pixel-plaza-v1.png', type: 'image', w: 192, h: 192, anchor: [96, 168] },
  { label: 'NPC:村人ピクセル', src: 'assets/env/npc_villager-pixel-plaza-v1.png', type: 'image', w: 192, h: 192, anchor: [96, 168] },
  { label: 'NPC:クエスト受付ピクセル', src: 'assets/env/npc_quest-pixel-plaza-v1.png', type: 'image', w: 192, h: 192, anchor: [96, 168] },
  { label: 'HUD:ステータスピクセル', src: 'assets/ui/hud-status-pixel-plaza-v1.png', type: 'image', w: 768, h: 88 },
];
