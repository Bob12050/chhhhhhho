...
out('|---|---|---|');
const bossSeriesPrefixes = ['lord_', 'guardian_', 'nox_', 'zephys_', 'vurm_', 'fenrir_', 'king_jelly', 'golden_', 'royal_robe', 'varga_', 'spora_', 'garo_', 'hydra_', 'glacies_', 'sandgoa_', 'mordo_', 'magia_', 'abyss_sce', 'abyss_ring', 'crimson_man'];
