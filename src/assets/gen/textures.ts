...
export const TEX = {
  ...
  playerBodyMale: 'art.player.body.male',
  playerBodyMaleDiagonal: 'art.player.body.male.diagonal',
  ...
  jobSamuraiDiagonal: 'art.char.samurai.diagonal',
  jobSorcerer: 'gen.char.sorcerer',
  jobSorcererDiagonal: 'art.char.sorcerer.diagonal',
  jobHolyKnight: 'gen.char.holy_knight',
  jobHolyKnightDiagonal: 'art.char.holy_knight.diagonal',
  jobNinja: 'gen.char.ninja',
  jobNinjaDiagonal: 'art.char.ninja.diagonal',
  jobRanger: 'gen.char.ranger',
  jobRangerDiagonal: 'art.char.ranger.diagonal',
  jobSwordKaiser: 'gen.char.sword_kaiser',
  jobSwordKaiserDiagonal: 'art.char.sword_kaiser.diagonal',
  ...
  jobShieldSaberDiagonal: 'art.char.shield_saber.diagonal',
  jobAvengista: 'gen.char.avengista',
  jobAvengistaDiagonal: 'art.char.avengista.diagonal',
  jobDualStar: 'gen.char.dual_star',
  jobDualStarDiagonal: 'art.char.dual_star.diagonal',
  jobAramikagura: 'gen.char.aramikagura',
  jobAramikaguraDiagonal: 'art.char.aramikagura.diagonal',
  jobAlvride: 'gen.char.alvride',
  jobAlvrideDiagonal: 'art.char.alvride.diagonal',
  jobNirvadio: 'gen.char.nirvadio',
  jobNirvadioDiagonal: 'art.char.nirvadio.diagonal',
  jobNoxtia: 'gen.char.noxtia',
  jobNoxtiaDiagonal: 'art.char.noxtia.diagonal',
  jobOltarie: 'gen.char.oltarie',
  jobOltarieDiagonal: 'art.char.oltarie.diagonal',
  jobFighterMale: 'art.char.fighter.male',
  jobFighterMaleDiagonal: 'art.char.fighter.male.diagonal',
  jobMageMale: 'art.char.mage.male',
  jobMageMaleDiagonal: 'art.char.mage.male.diagonal',
  jobPriestMale: 'art.char.priest.male',
  jobPriestMaleDiagonal: 'art.char.priest.male.diagonal',
  jobThiefMale: 'art.char.thief.male',
  jobThiefMaleDiagonal: 'art.char.thief.male.diagonal',
  jobPetRaiserMale: 'art.char.pet_raiser.male',
  jobPetRaiserMaleDiagonal: 'art.char.pet_raiser.male.diagonal',
  jobSamuraiMale: 'art.char.samurai.male',
  jobSamuraiMaleDiagonal: 'art.char.samurai.male.diagonal',
  jobSorcererMale: 'art.char.sorcerer.male',
  jobSorcererMaleDiagonal: 'art.char.sorcerer.male.diagonal',
  jobHolyKnightMale: 'art.char.holy_knight.male',
  jobHolyKnightMaleDiagonal: 'art.char.holy_knight.male.diagonal',
  jobNinjaMale: 'art.char.ninja.male',
  jobNinjaMaleDiagonal: 'art.char.ninja.male.diagonal',
  jobRangerMale: 'art.char.ranger.male',
  jobRangerMaleDiagonal: 'art.char.ranger.male.diagonal',
  jobSwordKaiserMale: 'art.char.sword_kaiser.male',
  jobSwordKaiserMaleDiagonal: 'art.char.sword_kaiser.male.diagonal',
  jobGrandMagiaMale: 'art.char.grand_magia.male',
  jobGrandMagiaMaleDiagonal: 'art.char.grand_magia.male.diagonal',
  jobShieldSaberMale: 'art.char.shield_saber.male',
  jobShieldSaberMaleDiagonal: 'art.char.shield_saber.male.diagonal',
  jobAvengistaMale: 'art.char.avengista.male',
  jobAvengistaMaleDiagonal: 'art.char.avengista.male.diagonal',
  jobDualStarMale: 'art.char.dual_star.male',
  jobDualStarMaleDiagonal: 'art.char.dual_star.male.diagonal',
  jobAramikaguraMale: 'art.char.aramikagura.male',
  jobAramikaguraMaleDiagonal: 'art.char.aramikagura.male.diagonal',
  jobAlvrideMale: 'art.char.alvride.male',
  jobAlvrideMaleDiagonal: 'art.char.alvride.male.diagonal',
  jobNirvadioMale: 'art.char.nirvadio.male',
  jobNirvadioMaleDiagonal: 'art.char.nirvadio.male.diagonal',
  jobNoxtiaMale: 'art.char.noxtia.male',
  jobNoxtiaMaleDiagonal: 'art.char.noxtia.male.diagonal',
  jobOltarieMale: 'art.char.oltarie.male',
  jobOltarieMaleDiagonal: 'art.char.oltarie.male.diagonal',
  ...
  arenaCavernMap: 'art.map.arena.cavern.pixel.v1',
  arenaSwampMap: 'art.map.arena.swamp.pixel.v1',
  arenaRuinsMap: 'art.map.arena.ruins.pixel.v1',
  arenaAbyssMap: 'art.map.arena.abyss.pixel.v1',
  arenaMarshMap: 'art.map.arena.marsh.pixel.v1',
  arenaPeakMap: 'art.map.arena.peak.pixel.v1',
  arenaNightMap: 'art.map.arena.night.pixel.v1',
  arenaCanyonMap: 'art.map.arena.canyon.pixel.v1',
