...
export const ASSET_MANIFEST: AssetEntry[] = [
  ...
  sheet(TEX.jobMage, 'assets/char/job_mage-storybook-v3.png'),
  sheet(TEX.jobMageDiagonal, 'assets/char/job_mage-diagonal-v1.png'),
  sheet(TEX.jobPriest, 'assets/char/job_priest-storybook-v3.png'),
  sheet(TEX.jobPriestDiagonal, 'assets/char/job_priest-diagonal-v1.png'),
  sheet(TEX.jobThief, 'assets/char/job_thief-storybook-v3.png'),
  sheet(TEX.jobThiefDiagonal, 'assets/char/job_thief-diagonal-v1.png'),
  sheet(TEX.jobPetRaiser, 'assets/char/job_pet_raiser-storybook-v3.png'),
  sheet(TEX.jobPetRaiserDiagonal, 'assets/char/job_pet_raiser-diagonal-v1.png'),
