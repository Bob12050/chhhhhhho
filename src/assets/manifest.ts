...
export const ASSET_MANIFEST: AssetEntry[] = [
  ...
  // Fighter paper-doll pilot. Original job sheets remain loaded below and are
  // used whenever the player disables the layered appearance setting.
  sheet(TEX.paperDollPilotBase, 'assets/paperdoll-pilot/base-cardinal-v1.png'),
  sheet(TEX.paperDollPilotBaseDiagonal, 'assets/paperdoll-pilot/base-diagonal-v1.png'),
  sheet(TEX.paperDollPilotHead, 'assets/paperdoll-pilot/helm-iron-cardinal-v1.png'),
  sheet(TEX.paperDollPilotHeadDiagonal, 'assets/paperdoll-pilot/helm-iron-diagonal-v1.png'),
  sheet(TEX.paperDollPilotTorso, 'assets/paperdoll-pilot/torso-iron-cardinal-v1.png'),
  sheet(TEX.paperDollPilotTorsoDiagonal, 'assets/paperdoll-pilot/torso-iron-diagonal-v1.png'),
  sheet(TEX.paperDollPilotFarHand, 'assets/paperdoll-pilot/hand-far-iron-cardinal-v1.png'),
  sheet(TEX.paperDollPilotFarHandDiagonal, 'assets/paperdoll-pilot/hand-far-iron-diagonal-v1.png'),
  sheet(TEX.paperDollPilotNearHand, 'assets/paperdoll-pilot/hand-near-iron-cardinal-v1.png'),
  sheet(TEX.paperDollPilotNearHandDiagonal, 'assets/paperdoll-pilot/hand-near-iron-diagonal-v1.png'),
  sheet(TEX.paperDollPilotFeet, 'assets/paperdoll-pilot/feet-iron-cardinal-v1.png'),
  sheet(TEX.paperDollPilotFeetDiagonal, 'assets/paperdoll-pilot/feet-iron-diagonal-v1.png'),
  sheet(TEX.paperDollPilotSword, 'assets/paperdoll-pilot/sword-iron-cardinal-v1.png'),
  sheet(TEX.paperDollPilotSwordDiagonal, 'assets/paperdoll-pilot/sword-iron-diagonal-v1.png'),
  sheet(TEX.paperDollPilotShield, 'assets/paperdoll-pilot/shield-iron-cardinal-v1.png'),
  sheet(TEX.paperDollPilotShieldDiagonal, 'assets/paperdoll-pilot/shield-iron-diagonal-v1.png'),
