...
export const ASSET_MANIFEST: AssetEntry[] = [
  ...
  sheet(TEX.playerBodyMale, 'assets/char/player_body-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.playerBodyMaleDiagonal, 'assets/char/player_body-male-diagonal-hd-v2.webp', 192, 192),
  ...
  sheet(TEX.jobFighterMale, 'assets/char/job_fighter-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobFighterMaleDiagonal, 'assets/char/job_fighter-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobMageMale, 'assets/char/job_mage-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobMageMaleDiagonal, 'assets/char/job_mage-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobPriestMale, 'assets/char/job_priest-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobPriestMaleDiagonal, 'assets/char/job_priest-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobThiefMale, 'assets/char/job_thief-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobThiefMaleDiagonal, 'assets/char/job_thief-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobPetRaiserMale, 'assets/char/job_pet_raiser-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobPetRaiserMaleDiagonal, 'assets/char/job_pet_raiser-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobSamuraiMale, 'assets/char/job_samurai-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobSamuraiMaleDiagonal, 'assets/char/job_samurai-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobSorcererMale, 'assets/char/job_sorcerer-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobSorcererMaleDiagonal, 'assets/char/job_sorcerer-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobHolyKnightMale, 'assets/char/job_holy_knight-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobHolyKnightMaleDiagonal, 'assets/char/job_holy_knight-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobNinjaMale, 'assets/char/job_ninja-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobNinjaMaleDiagonal, 'assets/char/job_ninja-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobRangerMale, 'assets/char/job_ranger-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobRangerMaleDiagonal, 'assets/char/job_ranger-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobSwordKaiserMale, 'assets/char/job_sword_kaiser-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobSwordKaiserMaleDiagonal, 'assets/char/job_sword_kaiser-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobGrandMagiaMale, 'assets/char/job_grand_magia-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobGrandMagiaMaleDiagonal, 'assets/char/job_grand_magia-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobShieldSaberMale, 'assets/char/job_shield_saber-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobShieldSaberMaleDiagonal, 'assets/char/job_shield_saber-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobAvengistaMale, 'assets/char/job_avengista-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobAvengistaMaleDiagonal, 'assets/char/job_avengista-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobDualStarMale, 'assets/char/job_dual_star-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobDualStarMaleDiagonal, 'assets/char/job_dual_star-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobAramikaguraMale, 'assets/char/job_aramikagura-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobAramikaguraMaleDiagonal, 'assets/char/job_aramikagura-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobAlvrideMale, 'assets/char/job_alvride-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobAlvrideMaleDiagonal, 'assets/char/job_alvride-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobNirvadioMale, 'assets/char/job_nirvadio-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobNirvadioMaleDiagonal, 'assets/char/job_nirvadio-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobNoxtiaMale, 'assets/char/job_noxtia-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobNoxtiaMaleDiagonal, 'assets/char/job_noxtia-male-diagonal-hd-v2.webp', 192, 192),
  sheet(TEX.jobOltarieMale, 'assets/char/job_oltarie-male-storybook-hd-v2.webp', 192, 192),
  sheet(TEX.jobOltarieMaleDiagonal, 'assets/char/job_oltarie-male-diagonal-hd-v2.webp', 192, 192),
  ...
  img(TEX.arenaMarshMap, 'assets/maps/arena-marsh-pixel-plaza-hd-v1.webp'),
  img(TEX.arenaPeakMap, 'assets/maps/arena-peak-pixel-plaza-hd-v1.webp'),
  img(TEX.arenaNightMap, 'assets/maps/arena-night-pixel-plaza-hd-v1.webp'),
  img(TEX.arenaCanyonMap, 'assets/maps/arena-canyon-pixel-plaza-hd-v1.webp'),
